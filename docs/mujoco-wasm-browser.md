...
- Несколько keyframes: до двух дополнительных **сохранённых поз** плюс текущая поза; экспорт в Авторинг / Конвейер / черновик на платформе — один Phase 0 JSON с массивом `keyframes`.
