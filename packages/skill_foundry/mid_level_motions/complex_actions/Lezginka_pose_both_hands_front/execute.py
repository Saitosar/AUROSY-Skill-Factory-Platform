"""
SAI Motion Builder: Lezginka_pose_both_hands_front (сгенерировано Pose Studio).
...
if __name__ == "__main__":
    LezginkaPoseBothHandsFrontSkill().execute(hold_at_end=True)
