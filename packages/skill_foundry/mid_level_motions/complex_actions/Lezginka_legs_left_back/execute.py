"""
SAI Motion Builder: Lezginka_legs_lef_back (сгенерировано Pose Studio).
...
if __name__ == "__main__":
    LezginkaLegsLefBackSkill().execute(hold_at_end=True)
