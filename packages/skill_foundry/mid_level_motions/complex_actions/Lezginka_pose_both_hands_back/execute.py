"""
SAI Motion Builder: Lezginka_pose_both_hands_back (сгенерировано Pose Studio).
...
if __name__ == "__main__":
    LezginkaPoseBothHandsBackSkill().execute(hold_at_end=True)
