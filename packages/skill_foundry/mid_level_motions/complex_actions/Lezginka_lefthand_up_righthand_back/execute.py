"""
SAI Motion Builder: Lezginka_lefthand_up_righthand_back (сгенерировано Pose Studio).
...
if __name__ == "__main__":
    LezginkaLefthandUpRighthandBackSkill().execute(hold_at_end=True)
