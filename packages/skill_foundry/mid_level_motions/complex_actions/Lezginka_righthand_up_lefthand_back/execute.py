"""
SAI Motion Builder: Lezginka_righthand_up_lefthand_back (сгенерировано Pose Studio).
...
if __name__ == "__main__":
    LezginkaRighthandUpLefthandBackSkill().execute(hold_at_end=True)
