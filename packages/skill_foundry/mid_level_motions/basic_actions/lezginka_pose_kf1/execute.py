"""
SAI Motion Builder: lezginka_pose_kf1 (кадр 1 из Lezginka_pose_both_hands_front).
...
if __name__ == "__main__":
    LezginkaPoseKf1Skill().execute(hold_at_end=True)
