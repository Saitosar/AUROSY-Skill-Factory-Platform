"""
SAI Motion Builder: lezginka_pose_kf3 (кадр 3 из Lezginka_pose_both_hands_front).
...
if __name__ == "__main__":
    LezginkaPoseKf3Skill().execute(hold_at_end=True)
