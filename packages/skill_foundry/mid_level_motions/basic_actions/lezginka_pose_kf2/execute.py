"""
SAI Motion Builder: lezginka_pose_kf2 (кадр 2 из Lezginka_pose_both_hands_front).
...
if __name__ == "__main__":
    LezginkaPoseKf2Skill().execute(hold_at_end=True)
